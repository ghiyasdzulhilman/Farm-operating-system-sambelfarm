...
export function DashboardPage() {
  ...
  const {
    ...
    // Query key di-update biar auto-fetch pas filter bulan/tahun berubah
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      {/* FILTER BAR YANG BARU (Bulan, Tahun, Area) */}
                ...
                {isLoadingSummary ? <Skeleton className="h-9 w-full" /> : (
                  <>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Berdasarkan {displayData.harvestWeight} kg panen bulan ini.
                    </p>
                  </>
                )}
              </CardContent>
              ...
              <CardContent>
                {isLoadingSummary ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-8 text-center border-2 border-dashed rounded-lg border-muted">
                    <p className="text-sm text-muted-foreground">Belum ada pengeluaran tercatat di bulan ini.</p>
                  </div>
                ) : (
                        ...
                        <div key={index} className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <div className="flex gap-3 text-muted-foreground">
                              ...
                              <span className="w-10 text-right font-semibold text-rose-600">{percentage.toFixed(0)}%</span>
                            </div>
                          </div>
